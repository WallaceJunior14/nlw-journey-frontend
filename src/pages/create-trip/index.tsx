...
export function CreateTripPage() {
  ...
  async function createTrip(event: FormEvent<HTMLFormElement>) {
    ...
    if (!eventStartsAndEndDates?.from || !eventStartsAndEndDates.to) return
    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-full px-6 text-center space-y-10">
        ...
        <p className="text-sm text-zinc-500">
          Ao planejar sua viagem pela plen.ner você automaticamente concorda <br/>
          com nossos <a href="#" className="text-zinc-300 underline"> termos de uso</a> e <a href="#" className="text-zinc-300 underline">politicas de privacidade</a>.
        </p>
      </div>
