        ...
        return (
          <div key={category.date} className="space-y-2.5">
            ...
            {category.activities.length > 0 ? (
                ...
                {category.activities.map(activity => {
                  return (
                    <div key={activity.id} className="space-y-2.5">
                      ...
                      <span className="text-zinc-400 text-sm ml-auto">{format(activity.accurs_at, 'HH:mm')}h</span>
                      </div>
                  </div>
                  )
                })}
              ...
              <p className="text-zinc-500 text-sm">Nenhuma atividae cadastrada nessa data.</p>
            )}
          </div>
        )
      })}
